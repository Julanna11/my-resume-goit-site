...
const callbackRequestModal = document.querySelector ('#request');
...
callbackRequestModal.classList.add('modal-active');

setTimeout(function() {
    callbackRequestModal.classList.remove('modal-active');
},2000);
